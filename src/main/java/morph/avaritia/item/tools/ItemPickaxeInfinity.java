...
public class ItemPickaxeInfinity extends ItemPickaxe {
    ...
    public float getDestroySpeed(ItemStack stack, IBlockState state) {
        ...
        return Math.max(super.getDestroySpeed(stack, state), 6000.0F);
    ...
    @Override
    public boolean canHarvestBlock(IBlockState p_canHarvestBlock_1_, ItemStack p_canHarvestBlock_2_) {
        return true;
    }
